...
class SpellSystem {
	...
	function __construct($projPerPlayer = 4){
		...
		$humans->justonce(
			...
			$this->SpellSlotDCs[3]->setTo(self::_Zap),
			$this->SpellSlotDCs[4]->setTo(self::_Holocaust),
		'');
	...
	private function countUpDCs($otherdcs, Deathcounter $basedc, Deathcounter $tempdc){
